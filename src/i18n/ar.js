const ar = {
  ...
  adminDashboard: {
    ...
    artisansCardTitle: 'الحرفيون',
    artisansTotal: 'إجمالي الحرفيين',
    usersCardTitle: 'المستخدمون',
    usersTotal: 'إجمالي المستخدمين',
    otherRequests: 'أخرى',
    completionCardTitle: 'معدّل إنجاز الطلبات',
    completionSubtitle: 'من إجمالي الطلبات المسجّلة',
    completionLegendDone: 'مكتملة',
    completionLegendRest: 'غير مكتملة',
    requestsCardTitle: 'الطلبات',
    ratingCardTitle: 'تقييم الخدمة',
    ratingCount: 'تقييم',
    ratingExcellent: 'ممتاز',
    ratingGood: 'جيد',
    ratingFair: 'متوسط',
    ratingPoor: 'ضعيف',
    ratingNone: 'لا تقييمات بعد',
  },
  adminRequests: {
    title: 'إدارة الطلبات',
    ...
    home: 'الرئيسية',
    artisans: 'تصفح الحرفيين',
    accountTitle: 'حسابك',
    residentLogin: 'دخول الساكن',
    residentRegister: 'إنشاء حساب ساكن',
    artisanLogin: 'دخول الحرفي',
    artisanRegister: 'انضمّ كحرفي',
    compound: 'مجمع البدور السكني',
    rights: 'جميع الحقوق محفوظة',
  },
    about: {
    title: 'من نحن',
    lead: 'Fixoria منصة تربط سكان مجمع البدور السكني بحرفيين ومزوّدي خدمات صيانة موثوقين، بضغطة زر واحدة.',
    missionTitle: 'رسالتنا',
    missionText:
      'نسعى لتسهيل حياة السكان اليومية عبر ربطهم بحرفيين محليين تم التحقق منهم، وتوفير تجربة سلسة وآمنة لطلب خدمات الصيانة ومتابعتها.',
    howTitle: 'كيف يعمل Fixoria؟',
    step1: 'تصفّح التصنيفات واختاري الخدمة التي تحتاجينها.',
    step2: 'أرسلي طلبًا بتفاصيل بسيطة، وسيقبله أقرب حرفي متاح.',
    step3: 'تابعي حالة الطلب أولًا بأول، وقيّمي الخدمة بعد اكتمالها.',
  },
  contact: {
    title: 'اتصل بنا',
    ...
    title: 'لوحتي',
    greeting: 'مرحبًا',
    heroSubtitle: 'نظرة عامة على أدائك وطلباتك',
    loading: 'جارٍ التحميل...',
