const en = {
  ...
  adminDashboard: {
    ...
    greeting: 'Hello',
    subtitle: 'An overview of platform performance',
    artisansCardTitle: 'Artisans',
    artisansTotal: 'Total artisans',
    usersCardTitle: 'Users',
    usersTotal: 'Total users',
    otherRequests: 'Other',
    completionCardTitle: 'Request completion rate',
    completionSubtitle: 'Of all registered requests',
    completionLegendDone: 'Completed',
    completionLegendRest: 'Not completed',
    requestsCardTitle: 'Requests',
    ratingCardTitle: 'Service rating',
    ratingCount: 'reviews',
  ...
  contact: {
    ...
    title: 'My Dashboard',
    greeting: 'Hello',
    heroSubtitle: 'An overview of your performance and requests',
    loading: 'Loading...',
